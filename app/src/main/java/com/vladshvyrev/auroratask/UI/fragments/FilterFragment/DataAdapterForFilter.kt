...
import kotlinx.android.synthetic.main.item_data_for_filter.view.*


class DataAdapterForFilter(val clickListener: (Data) -> Unit): RecyclerView.Adapter<DataAdapterForFilter.BlogViewHolder>() {
    private var items = mutableListOf<Data>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BlogViewHolder {
        return BlogViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_data_for_filter, parent, false)
        )
    }
